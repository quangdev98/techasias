...
Route::get("business",'homeController@getBusiness')->name('business');
Route::get("life-style/{slug}", 'homeController@getLifeStyle')->name('life-style');
Route::get("technology/{slug}",'homeController@getTechnology')->name('technology');
Route::get("sports/{slug}",'homeController@getSports')->name('sports');
...
Route::get("post-detail/{id}",'homeController@detailPost')->name('post-detail');
